# Port Test: `BooleanComplex_GenericTwinBooleanTest7863`

> **Test #14 of 58.** Port this single test to C. Make it pass. Commit. Then move to the next test.
...
make
TEST=BooleanComplex_GenericTwinBooleanTest7863 ./test_manifold          # run this test alone
...
3. Write the C test function `test_BooleanComplex_GenericTwinBooleanTest7863(void)` in `src_c/test_manifold.c`.
4. Add `RUN_TEST(BooleanComplex_GenericTwinBooleanTest7863);` to the appropriate section in `main()`.
5. Build and run: `TEST=BooleanComplex_GenericTwinBooleanTest7863 ./test_manifold`
...
8. Commit: `test: port BooleanComplex_GenericTwinBooleanTest7863 from C++`
...
1. This prompt is about ONE test: `BooleanComplex_GenericTwinBooleanTest7863`. Do not work on other tests.
...
5. Commit: `test: port BooleanComplex_GenericTwinBooleanTest7863 from C++`
