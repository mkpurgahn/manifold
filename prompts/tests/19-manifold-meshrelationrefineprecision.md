# Port Test: `Manifold_MeshRelationRefinePrecision`

> **Test #19 of 58.** Port this single test to C. Make it pass. Commit. Then move to the next test.
...
make
TEST=Manifold_MeshRelationRefinePrecision ./test_manifold          # run this test alone
...
3. Write the C test function `test_Manifold_MeshRelationRefinePrecision(void)` in `src_c/test_manifold.c`.
4. Add `RUN_TEST(Manifold_MeshRelationRefinePrecision);` to the appropriate section in `main()`.
5. Build and run: `TEST=Manifold_MeshRelationRefinePrecision ./test_manifold`
...
8. Commit: `test: port Manifold_MeshRelationRefinePrecision from C++`
...
1. This prompt is about ONE test: `Manifold_MeshRelationRefinePrecision`. Do not work on other tests.
...
5. Commit: `test: port Manifold_MeshRelationRefinePrecision from C++`
