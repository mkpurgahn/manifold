# Port Test: `Properties_MingapStretchyBracelet`

> **Test #37 of 58.** Port this single test to C. Make it pass. Commit. Then move to the next test.
...
make
TEST=Properties_MingapStretchyBracelet ./test_manifold          # run this test alone
...
3. Write the C test function `test_Properties_MingapStretchyBracelet(void)` in `src_c/test_manifold.c`.
4. Add `RUN_TEST(Properties_MingapStretchyBracelet);` to the appropriate section in `main()`.
5. Build and run: `TEST=Properties_MingapStretchyBracelet ./test_manifold`
...
8. Commit: `test: port Properties_MingapStretchyBracelet from C++`
...
1. This prompt is about ONE test: `Properties_MingapStretchyBracelet`. Do not work on other tests.
...
5. Commit: `test: port Properties_MingapStretchyBracelet from C++`
